...
bot_token = environ.get('BOT_TOKEN', '7052945751:AAFARzYIDnF4QoXO3ntBPPDcFeHuVz6dfsA')
if len(bot_token) == 0:
    logging.error("BOT_TOKEN variable is missing! Exiting now")
    exit(1)
dump_id = environ.get('DUMP_CHAT_ID', '-1002169821738')
if len(dump_id) == 0:
...
fsub_id = environ.get('FSUB_ID', '-1002223290043')
if len(fsub_id) == 0:
...
async def start_command(client, message):
    ...
    join_button = InlineKeyboardButton("ᴊᴏɪɴ ", url="https://t.me/teraleesh")
    developer_button = InlineKeyboardButton("ᴅᴇᴠᴇʟᴏᴘᴇʀ⚡️", url="https://t.me/@Itachinix")
