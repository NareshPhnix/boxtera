...
bot_token = environ.get('BOT_TOKEN', '7458046887:AAGobBZpf2XLojnprogl0GRjaePQJdQ6_Ac')
if len(bot_token) == 0:
    logging.error("BOT_TOKEN variable is missing! Exiting now")
    exit(1)
dump_id = environ.get('DUMP_CHAT_ID', '-1002179012874')
if len(dump_id) == 0:
...
fsub_id = environ.get('FSUB_ID', '-1002195196378')
if len(fsub_id) == 0:
...
async def start_command(client, message):
    ...
    join_button = InlineKeyboardButton("ᴊᴏɪɴ ", url="https://t.me/teraboxdownloaderr1")
